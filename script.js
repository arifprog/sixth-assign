...
addBtn.addEventListener('click',(event)=>{
    ...
    editButton.className = 'ml-[223px] md:ml-[800px] bg-green-500 hover:bg-lime-600 text-white font-bold w-[17px] md:w-[50px] py-3 rounded-xl shadow-md ';
    ...
    doneButton.className = 'ml-[10px] md:ml-[800px] bg-orange-500 hover:bg-amber-700 text-white font-bold w-[17px] md:w-[50px] py-3 rounded-xl shadow-md ';
    ...
    deleteButton.className = 'ml-[10px] md:ml-[800px] bg-red-500 hover:bg-rose-700 text-white font-bold w-[17px] md:w-[50px] py-3 rounded-xl shadow-md  ';
